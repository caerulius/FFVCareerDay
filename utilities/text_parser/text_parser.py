...
text_dict = pd.read_csv('../data/tables/text_table.csv',header=None,index_col=0).to_dict()[1]
text_dict2 = pd.read_csv('../data/tables/text_table.csv',header=None,index_col=1).to_dict()[0]
...
job_dict= {'.':'E','WALSE METEOR':'e','RUINED CITY METEOR':'e'}
def run_encrypt():
